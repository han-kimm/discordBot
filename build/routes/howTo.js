...
const howTo_1 = require("../prompts/howTo");
exports.default = {
    howTo: {
        async route(ctx) {
            ...
            if (passOrRetrieve === "pass") {
                ...
                //@ts-expect-error
                const chain = howTo_1.howToPrompt.pipe(llm);
        ...
        description: "when the user is not sure how to do something. e.g. install a package, use a tool and quickstart guide.",
    },
};
